...
def generator_plot_test_callback_as_method(self, output, inputs, show=False, save_path=None, index=-1):
...
def firstiter_plot_test_callback_as_method(self, output, inputs, show=False, save_path=None):

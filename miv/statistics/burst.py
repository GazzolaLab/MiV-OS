# Bursting_Analysis: Burst length, location, and rate
...
def burst(spiketrains: SpikestampsType, channel: float, min_isi: float, min_len: float):
    ...
    # Calculates parameters critical to characterize bursting phenomenon on a singl channel
